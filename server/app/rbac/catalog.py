...
CATALOG: tuple[Permission, ...] = (
    ...
    Permission("plugin:read", "plugin", description="View installed plugins"),
    Permission(
        "plugin:install",
        "plugin",
        high_risk=True,
    ...
    Permission(
        ...
        "plugin",
        high_risk=True,
        description="Manage plugin lifecycle (ack, update, uninstall)",
    ),
    Permission("plugin:configure", "plugin", description="Configure plugin settings"),
    Permission("plugin:invoke", "plugin", description="Invoke plugin actions"),

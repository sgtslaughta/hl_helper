...
describe('PaneChrome', () => {
	it('renders primary tabs and groups overflow into More menu', () => {
		render(
			<PaneChrome label="Focus" tabs={tabs} value="a" onChange={() => {}} actions={[]}>
				body
			</PaneChrome>,
		);
	...
	it('marks active tab with aria-selected', () => {
		render(
			<PaneChrome label="Focus" tabs={tabs} value="b" onChange={() => {}} actions={[]}>
				x
			</PaneChrome>,
		);
	...
	it('fires onChange when tab clicked', () => {
		...
		render(
			<PaneChrome label="Focus" tabs={tabs} value="a" onChange={onChange} actions={[]}>
				x
			</PaneChrome>,
		);
	...
	it('shows active overflow tab label in More trigger', () => {
		render(
			<PaneChrome label="Focus" tabs={tabs} value="e" onChange={() => {}} actions={[]}>
				x
			</PaneChrome>,
		);

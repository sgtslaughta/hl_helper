...
import { type PendingToken, revokePendingToken } from '@/lib/api/enrollment';
	...
	return (
		<tr className="border-b border-hairline bg-yellow-500/5">
			<td className="px-4 py-2 text-text">
				<span className="mr-2 inline-flex items-center rounded bg-yellow-500/15 px-1.5 py-0.5 text-xs text-yellow-400">
					pending
				</span>
